...
import { Sparkles, Brain, MapPin, BookOpen, X, ArrowLeft, Save, Loader2, EyeOff, Users, Lightbulb, Heart, Sun, Target, ChevronDown, ChevronUp } from "lucide-react";
                  ...
                  <div className="space-y-2">
                    <div>
                      ...
                      <div className="flex flex-wrap gap-1 mt-1">
                        {suggestedTags.effects.filter(t => !tags.includes(t)).map((tag) => (
                          <Badge
                            key={tag}
                            variant="outline"
                    ...
                    <div>
                      ...
                      <div className="flex flex-wrap gap-1 mt-1">
                        {suggestedTags.emotions.filter(t => !tags.includes(t)).map((tag) => (
                          <Badge
                            key={tag}
                            variant="outline"
                            className="cursor-pointer text-xs"
                    ...
                    <div>
                      ...
                      <div className="flex flex-wrap gap-1 mt-1">
                        {suggestedTags.insights.filter(t => !tags.includes(t)).map((tag) => (
                          <Badge
                            key={tag}
                            variant="outline"
                            className="cursor-pointer text-xs"
